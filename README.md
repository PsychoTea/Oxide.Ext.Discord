# Oxide.Ext.Discord [![Master](https://ci.appveyor.com/api/projects/status/Oxide.Ext.Discord/branch/master)](https://ci.appveyor.com/project/PsychoTea/oxide-ext-discord/branch/master)
