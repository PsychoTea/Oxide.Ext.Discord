namespace Oxide.Ext.Discord.DiscordObjects
{
    ...
    public class Channel
    {
        ...
        public void GetChannelMessage(DiscordClient client, Message message, Action<Message> callback = null) => this.GetChannelMessage(client, message.id, callback);
        ...
        public void GroupDMAddRecipient(DiscordClient client, User user, string accessToken, Action callback = null) => this.GroupDMAddRecipient(client, user.id, accessToken, user.username, callback);
